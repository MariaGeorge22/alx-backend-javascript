...
describe('Api Request', () => {
  ...
  it('should resolve correctly at endpoint: "/available_payments"', (done) => {
  ...
  it('should resolve correctly at endpoint: "/login"', (done) => {
    ...
    request.post({
      ...
      expect(res.statusCode).to.be.equal(200);
      expect(body).to.be.equal('Welcome David');
      done();
    });
  });
});
